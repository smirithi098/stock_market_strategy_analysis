...
data = pd.read_csv("S:/Dissertation 2023/Stock market analysis/stock_market_strategy_analysis/data_files/kotakbank.csv",
                   index_col=0, parse_dates=[0], dayfirst=True)
# Step 1
kotak_df = strat.prepare_data(data)

#%% Visualize the KOTAK BANK OHLC prices with volume

strat.plot_graph(kotak_df, 'KOTAK BANK')

# ##########################################  STRATEGY - 1  ############################################################
#%% Get the technical indicators for the strategy 1

# Step 2
data_subset_1 = strat.ema_crossover(kotak_df, kotak_df['close'])
...
# Step 2
data_subset_2 = strat.bollinger_bands_with_rsi(kotak_df, kotak_df['close'])
...
# Step 2
data_subset_3 = strat.macd_with_ema(kotak_df, kotak_df['close'])
...
# Step 2
data_subset_4 = strat.macd_with_rsi(kotak_df, kotak_df['close'])
